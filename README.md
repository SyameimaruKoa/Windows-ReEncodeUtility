...
**FFmpeg 内蔵：**
- **AAC（libfdk_aac/libfdk_aac）** - HE-AAC/AAC-LC, ビットレート指定(**非推奨**)
...
H.265/HEVC     - 最新標準、高圧縮
H.264/AVC      - 互換性最高
AV1 NVENC      - 次世代、極高圧縮（対応ハード未所持の為未検証）
VP9            - WebM 用（QSVのみ検証済み）
```
...
```powershell
# ログ出力例
[2011/04/08 00:00:00] [DEBUG] テスト結果: NVIDIA=False Intel=True AMD=False
[2011/04/08 00:00:00] [DEBUG]   エンコーダー: [h264_qsv, hevc_qsv, vp9_qsv]
[2011/04/08 00:00:00] [DEBUG]   HWアクセル  : [qsv, d3d11va, dxva2, vulkan]
```
